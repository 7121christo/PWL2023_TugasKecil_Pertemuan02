...
//charlesInfo.innerHTML = `Full name: ${charles.fullName}, Age: ${charles.age}, Gender: ${charles.isMale ? "Male" : "Female"}`;
...
// b. Tampilkan info dengan Template literals
charlesJobInfoSelector.innerHTML = `Full name: ${fullName}, Job: ${job}`;
